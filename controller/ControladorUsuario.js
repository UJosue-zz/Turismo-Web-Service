...
module.exports=function(modelo){
	return {
        ...
        modelo.sequelize.query("CALL Registro('"+peticion.body.nombre+"','"+peticion.body.nacionalidad+"','"+peticion.body.correo+"','"
            +peticion.body.nick+"','"+peticion.body.contrasena+"', '"+peticion.body.foto+"', '"+peticion.body.rol+"', '"+peticion.body.sitio+"');")
        .then(function(){
    ...
    login:function(peticion,respuesta){
        modelo.sequelize.query("CALL Login('"+peticion.query.nick+"', '"+peticion.query.contrasena+"');").then(function(data){
            if(data.length>0)
